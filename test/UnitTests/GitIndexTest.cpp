...
TEST_P(GitIndexCBasicGitWithTestRepoFixture, GetFileStatus)
{
	...
	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)CombinePath(m_Dir.GetTempDir(), L"ansi.txt"), L"this is testing file."));
	EXPECT_EQ(0, CGit::GetFileModifyTime(CombinePath(m_Dir.GetTempDir(), L"ansi.txt"), &time, nullptr, &filesize));
	status = git_wc_status_none;
	...
	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)CombinePath(m_Dir.GetTempDir(), L"just-added.txt"), L"this is testing file."));
	EXPECT_EQ(0, m_Git.Run(L"git.exe add -- just-added.txt", &output, CP_UTF8));

	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)CombinePath(m_Dir.GetTempDir(), L"noted-as-added.txt"), L"this is testing file."));
...
TEST(GitIndex, CGitIgnoreItem)
{
	...
	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)ignoreFile, L""));
	...
	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)ignoreFile, L"# comment"));
	EXPECT_EQ(0, ignoreItem.FetchIgnoreList(tempDir.GetTempDir(), ignoreFile, false));
	EXPECT_EQ(0, ignoreItem.FetchIgnoreList(tempDir.GetTempDir(), ignoreFile, true));
	...
	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)ignoreFile, L"*.tmp\n"));
	EXPECT_EQ(0, ignoreItem.FetchIgnoreList(tempDir.GetTempDir(), ignoreFile, false));
	type = DT_DIR;
	EXPECT_EQ(-1, ignoreItem.IsPathIgnored("not-ignored", type));
	...
	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)ignoreFile, L"some-file\n"));
	EXPECT_EQ(0, ignoreItem.FetchIgnoreList(tempDir.GetTempDir(), ignoreFile, false));
	type = DT_DIR;
	EXPECT_EQ(-1, ignoreItem.IsPathIgnored("not-ignored", type));
	EXPECT_EQ(-1, ignoreItem.IsPathIgnored("subdir/not-ignored", type));
	...
	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)ignoreFile, L"some-dir/"));
	EXPECT_EQ(0, ignoreItem.FetchIgnoreList(tempDir.GetTempDir(), ignoreFile, false));
	type = DT_DIR;
	...
	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)ignoreFile, L"some-*\n!some-file"));
	EXPECT_EQ(0, ignoreItem.FetchIgnoreList(tempDir.GetTempDir(), ignoreFile, false));
	type = DT_DIR;
	EXPECT_EQ(1, ignoreItem.IsPathIgnored("some-dir", type));
	...
	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)ignoreFile, L"/something"));
	EXPECT_EQ(0, ignoreItem.FetchIgnoreList(tempDir.GetTempDir(), ignoreFile, false));
