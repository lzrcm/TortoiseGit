...
TEST(CGitAdminDir, IsBareRepo_ReferencedRepo)
{
	...
	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)gitFile, L"gitdir: dontcare"));
...
TEST(CGitAdminDir, GetAdminDirPath_ReferencedRepo)
{
	...
	CString gitFile = tmpDir.GetTempDir() + L"\\.git";
	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)gitFile, L""));
	...
	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)gitFile, L"gitdir: ../something\n"));
	...
	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)gitFile, L"gitdir: ../\x4e2d\n"));
...
TEST(CGitAdminDir, HasAdminDir)
{
	...
	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)gitFile, L"something"));
...
TEST(CGitAdminDir, ReadGitLink)
{
	...
	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)gitFile, L"broken"));
	EXPECT_STREQ(L"", GitAdminDir::ReadGitLink(L"C:\\somerepo", gitFile));
	...
	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)gitFile, L"gitdir: ../.git/modules/dontcare"));
...
TEST(CGitAdminDir, GetGitTopDir)
{
	...
	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)testFile, L"something"));
	EXPECT_STREQ(L"", GitAdminDir::GetGitTopDir(gitFile + L"\\test"));
...
TEST(CGitAdminDir, GetSuperProjectRoot)
{
	...
	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)gitmodules, L"something"));
