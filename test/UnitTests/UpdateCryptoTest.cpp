...
TEST(UpdateCrypto, SimpleVerify)
{
	...
	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)testFile, L"Text"));
	...
	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)testFileSignature, (LPCWSTR)signature));
	EXPECT_EQ(0, VerifyIntegrity(testFile, testFileSignature, nullptr));

	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)testFileSignature, (LPCWSTR)signature.Left(50)));
	EXPECT_EQ(-1, VerifyIntegrity(testFile, testFileSignature, nullptr));
...
TEST(UpdateCrypto, NewLine)
{
	CAutoTempDir tempdir;
	CString testFile = tempdir.GetTempDir() + L"\\.test.txt";
	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)testFile, L"Text with\nNewline"));
