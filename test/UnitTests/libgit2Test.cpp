...
TEST(libgit2, Config)
{
	...
	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)testFile, L"[core]\nemail=dummy@example.com\ntrue=true\nfalse=false\n"));
...
TEST(libgit2, TGitPatches)
{
	...
	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)testFile, L"crlf\r\ncrlf\r\n"));
	EXPECT_EQ(0, git_index_add_bypath(index, "safecrlf-failure.txt"));

	EXPECT_TRUE(CStringUtils::WriteStringToTextFile((LPCWSTR)testFile, L"lf\nlf\n"));
