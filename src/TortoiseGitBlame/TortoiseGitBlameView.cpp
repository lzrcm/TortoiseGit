...
void CTortoiseGitBlameView::InitialiseEditor()
{
	...
	std::string fontName = CUnicodeUtils::StdGetUTF8((std::wstring)CRegStdString(L"Software\\TortoiseGit\\BlameFontName", L"Courier New"));
...
void CTortoiseGitBlameView::CreateFont()
{
	...
	CRegStdString fontname = CRegStdString(L"Software\\TortoiseGit\\BlameFontName", L"Courier New");
